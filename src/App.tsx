      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-lg border animate-in slide-in-from-right duration-500 space-y-6">
            {!isCpfValid ? (
              ...
              <div className="animate-fade-in space-y-6">
                ...
                {/* Identidade, Raça, Quilombola, PcD */}
        ...
        {step === 3 && (
          <div className="animate-in slide-in-from-right">
            <h2 className="text-2xl font-bold text-[#005AA5] mb-6">Blocos Comuns (1-5)</h2>
            {renderLikert("q1", "O curso estava relacionado às minhas necessidades?")}
            {renderLikert("q2", "Tenho um negócio onde o conteúdo pode ser aplicado?")}
            {renderLikert("q3", "O apoio do SEBRAE foi relevante?")}
