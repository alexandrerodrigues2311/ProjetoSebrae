      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        {step === 1 && (
          <div className="bg-white p-8 rounded-3xl shadow-lg border animate-in slide-in-from-right duration-500 space-y-6">
            {!isCpfValid ? (
              <>
                <h2 className="text-2xl font-bold text-[#005AA5]">Validação Inicial</h2>
              ...
              <div className="animate-fade-in space-y-6">
                ...
                {/* Campos de identidade, raça, quilombola e PcD mantidos conforme padrão aprovado */}
                <button onClick={() => setStep(2)} className="w-full bg-[#005AA5] text-white p-4 rounded-xl font-bold mt-6">Continuar</button>
              </div>
            )}
          </div>
        )}
